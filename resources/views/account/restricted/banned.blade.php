@extends('layouts.public', [
    'title' => 'Account Banned | CS2 PickLab',
...
<section class="account-restricted-page">
    <article class="account-restricted-card danger">
        <p class="account-restricted-kicker">Account Access Removed</p>

        <h1>You are no longer allowed to use this site.</h1>

        <p>
            You have been banned by {{ $adminName }}.
        </p>

        <p>
            If you feel you have reached this screen in error, contact
        ...
        @if($canAppeal)
            <div class="account-restricted-message">
                <strong>Appeal this ban</strong>

                @if($hasPendingAppeal)
                    <p>Your appeal is pending review.</p>
                @else
                    <p>
                        You may submit one appeal explaining why you believe this ban should be reviewed.
                    </p>

                    <form method="POST" action="{{ route('account.moderation-appeals.store', $incident) }}">
                        @csrf

                        <label for="ban-appeal-message">
                            Appeal message
                        </label>

                        <textarea
                            id="ban-appeal-message"
                            name="message"
                            required
                            minlength="20"
                            maxlength="5000"
